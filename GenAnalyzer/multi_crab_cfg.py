...
config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/'
...
if __name__ == '__main__':
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/Signal_LT/'
    ...
    config.General.requestName = 'Signal_LL'
    config.Data.inputDataset = '/WWJJToLNuQQ_LL_13TeV-madgraph-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/Signal_LL/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/Signal_TT/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/DYJetsToLL_amcatnlo_ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets_amcatnlo/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets_madgraph/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets100/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets100ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets100ext2/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets200/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets200ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets200ext2/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets400/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets400ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets600/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets600ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets800ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets1200/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets1200ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets2500/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WJets2500ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WW/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WZ/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/ZZ/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WW_excl/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WW_excl_ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WW_excl_amcatnlo/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/WZ_excl_amcatnlo/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/ZZ_excl_amcatnlo/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/TTbar_amcatnlo/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/TTbar_powheg'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/TTbar_'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/sch/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/tch_bar/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/tch/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/tWch_bar/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/tWch_bar_ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/tWch/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/LHE_GEN_Analyzer_Output/tWch_ext1/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
